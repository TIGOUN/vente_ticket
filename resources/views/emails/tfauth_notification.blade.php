                                                            ...
                                                            <tr>
                                                                <td align="center" valign="top" class="textContent">
                                                                    <h1
                                                                        ...
                                                                        Confirmez votre adresse électronique</h1>
                                                        ...
                                                        <table border="0" cellpadding="0" cellspacing="0" width="50%"
                                                            ...
                                                            <tr>
                                                                <td align="center" valign="middle" class="buttonContent"
                                                                    ...
                                                                    <div style="color:#FFFFFF;text-decoration:none;font-family:Helvetica,Arial,sans-serif;font-size:20px;line-height:135%;"
                                                                        href="#" target="_blank">{{ $opt }}</div>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                        <!-- // CONTENT TABLE -->
                                                                    ...
                                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                                        ...
                                                                        <tr>
                                                                            <td valign="top" class="textContent">
                                                                                <div
                                                                                    style="text-align:center;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;margin-top:3px;color:#5F5F5F;line-height:135%;">
                                                                                    Si vous n'avez pas demandé cet
                                                                                    e-mail, il n'y a pas lieu de
                                                                                    s'inquiéter - vous pouvez l'ignorer
                                                                                    en toute
                                                                                    sécurité.</div>
                                                                            </td>
                                                                        </tr>
